...
def test_paths():
    ...
    base_dir = script_dir  # evaluation_training/
    ...
    print(f"   LIDC Real: {base_dir.parent}/utility_training_resources/datasets/LIDC_real/")
    print(f"   EMIDEC Real: {base_dir.parent}/utility_training_resources/datasets/EMIDEC_real/")
    ...
    structure = """
    LeFusion/
    ├── evaluation_training/            # Main pipeline directory
